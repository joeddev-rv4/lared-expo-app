...
// Declaración para el script de Instagram
declare global {
  interface Window {
    instgrm?: {
      Embeds: {
          ...
          <div className="flex items-center justify-center gap-4">
            <div className="flex items-center gap-2">
              ...
              <div className="w-10 h-10 md:w-12 md:h-12 relative">
                ...
                >
                  <path
                    d="M3 20.5v-17c0-.59.34-1.11.84-1.35L13.69 12l-9.85 9.85c-.5-.24-.84-.76-.84-1.35zm13.81-5.38L6.05 21.34l8.49-8.49 2.27 2.27zm.53-.53l2.27-2.27L21.05 13l-2.27 2.27-1.44-1.18zM6.05 2.66l10.76 6.22-2.27 2.27L6.05 2.66z"
                    fill="#34A853"
                  />
                  <path
                    d="M13.69 12l2.27-2.27 5.39 3.12c.5.29.84.76.84 1.35 0 .59-.34 1.06-.84 1.35l-5.39 3.12L13.69 12z"
                    fill="#FBBC04"
                  />
                  <path
                    d="M3.84 3.15c-.5.24-.84.76-.84 1.35v17c0 .59.34 1.11.84 1.35L13.69 12 3.84 3.15z"
                    fill="#4285F4"
                  />
                  <path
                    d="M13.69 12l6.76-3.88c.5-.29.84-.76.84-1.35 0-.59-.34-1.06-.84-1.35L6.05 2.66 13.69 12z"
                    fill="#EA4335"
                  />
                </svg>
              </div>
          ...
          {testimonials.map((testimonial) => (
            <div key={testimonial.id} className="relative group mx-auto">
              ...
              <div className="relative rounded-2xl overflow-hidden shadow-xl hover:shadow-2xl transition-shadow duration-300">
                {/* Overlay con texto inicial */}
                <div className="absolute top-0 left-0 right-0 z-10 bg-gradient-to-b from-black/70 via-black/30 to-transparent pointer-events-none p-4">
                  <p className="text-white font-lato font-semibold text-base md:text-lg leading-tight drop-shadow-lg">
                    {testimonial.overlayText}
                  </p>
                </div>

                {/* Instagram Embed usando blockquote oficial */}
                <blockquote
