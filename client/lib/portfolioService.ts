...
export async function addPropertyToPortfolio(
  ...
  try {
    console.log(
      "Portfolio service - adding property:",
      propertyId,
      "for user:",
      userId,
    );
...
export async function removePropertyFromPortfolio(
  ...
  try {
    console.log(
      "Portfolio service - removing property:",
      propertyId,
      "for user:",
      userId,
    );
...
export async function togglePropertyInPortfolio(
  propertyId: string,
  isCurrentlyFavorite: boolean,
  userId: string,
): Promise<boolean> {
  console.log("Toggle property in portfolio:", {
    propertyId,
    isCurrentlyFavorite,
    userId,
  });
