...
const MESSAGES = [
  {
    id: "1",
    text: "¡Sigue así! Tu esfuerzo está dando frutos.",
    icon: "thumbs-up" as const,
    color: Colors.light.primary,
  },
  {
    id: "2",
    text: "No pares de compartir y ganar",
    icon: "share" as const,
    color: "#10B981",
  },
  {
    id: "3",
    text: "Gana Q750 por cada referido",
    icon: "cash" as const,
    color: "#8B5CF6",
  },
];
...
const OTHER_MESSAGES = [
  {
    id: "4",
    text: "Estás a solo un click de ganar Q750",
    icon: "finger-print" as const,
    color: "#F59E0B",
  },
  {
    id: "5",
    text: "Consigue clientes desde tu teléfono",
    icon: "phone-portrait" as const,
    color: "#EF4444",
  },
  {
    id: "6",
    text: "Comparte en tus redes sociales y gana",
...
export default function AchievementsScreenWeb() {
  ...
  const chartDataGanancias = {
    ...
    Week: [{ label: "Ganancias estimadas", values: [metrics.ganancias.value] }],
  };
    ...
    const fetchMetrics = async () => {
      ...
      try {
        ...
        const leadsResponse = await fetch(
          `${process.env.EXPO_PUBLIC_API_URL}/lead/user/${user.id}`,
          {
            headers: {
        ...
        const status11Response = await fetch(
          `${process.env.EXPO_PUBLIC_API_URL}/lead/count-status-11/${user.id}`,
          {
            headers: {
              "ngrok-skip-browser-warning": "true",
            },
        ...
        if (Array.isArray(leads)) {
          leads.forEach((lead) => {
            const date = new Date(
              lead.createdAt || lead.created_at || lead.date,
            );
        ...
        const sparkGananciasTotales = [
          gananciasTotalesValue * 0.7,
          gananciasTotalesValue * 0.8,
          gananciasTotalesValue * 0.75,
          gananciasTotalesValue * 0.9,
          gananciasTotalesValue * 0.85,
          gananciasTotalesValue * 0.95,
          gananciasTotalesValue,
        ];
        const sparkPropiedades = [
          propiedadesValue * 0.6,
          propiedadesValue * 0.7,
          propiedadesValue * 0.65,
          propiedadesValue * 0.8,
          propiedadesValue * 0.75,
          propiedadesValue * 0.9,
          propiedadesValue,
        ];
        const sparkClientes = [
          clientesValue * 0.5,
        ...
        setMetrics({
          ...
          gananciasTotales: {
            value: gananciasTotalesValue,
            spark: sparkGananciasTotales,
          },
        ...
        <View style={styles.dashboardGrid}>
          ...
          <View
            style={[
              styles.gridRow,
              styles.headerRow,
              isMobileWeb && styles.gridRowMobile,
            ]}
          >
            {/* Left: Title */}
            <View
              style={[
                styles.leftColumn,
                !isMobileWeb && { width: columnLeftWidth },
                isMobileWeb && styles.leftColumnMobile,
              ]}
            >
              <ThemedText style={[styles.pageTitle, { textAlign: "center" }]}>
                Mis Logros
              </ThemedText>
              <ThemedText
                style={[
              ...
              <View style={styles.controls}>
                ...
                >
                  <Pressable
                    ...
                    style={[
                      styles.toggleBtn,
                      timeRange === "Month" && styles.activeToggle,
                    ]}
                  >
                    <ThemedText
                      style={[
                        styles.toggleText,
                        timeRange === "Month" && styles.activeToggleText,
                      ]}
                    >
                      Este mes
                    </ThemedText>
              ...
              <View
                style={[
                  styles.metricsStack,
                  {
                    ...
                    gap: isMobileWeb ? Spacing.md : 0,
                    alignItems: "center",
                    flexWrap: isMobileWeb ? "nowrap" : "wrap",
                  },
                ]}
              >
                <DashboardMetricCard
          ...
          >
            ...
            <View
              style={[
                styles.rightColumn,
                { width: columnRightWidth, justifyContent: "center" },
              ]}
            >
